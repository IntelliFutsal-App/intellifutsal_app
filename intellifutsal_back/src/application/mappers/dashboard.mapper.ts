import { CoachDashboardResponse, PlayerDashboardResponse, TeamMiniResponse, CountByStatusResponse, TimeSeriesPointResponse, PositionDistributionResponse, CountByKeyResponse, DayOfWeekPointResponse, JoinRequestReviewTimeResponse, TeamActivityResponse, WeekSeriesPointResponse } from '../../domain/interfaces/dashboard';
