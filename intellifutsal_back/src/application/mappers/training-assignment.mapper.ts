import { TrainingAssignmentResponse, CreateTrainingAssignmentRequest } from '../../domain/interfaces';
import { TrainingAssignment, TrainingPlan, Player, Team, Coach } from '../../infrastructure/models';
