import { CreatePlayerRequest, PlayerResponse, UpdatePlayerRequest } from '../../domain/interfaces';
import { Credential, Player } from '../../infrastructure/models';
import { stringToPosition } from '../../domain/interfaces/enums/position.enum';
...
export class PlayerMapper {
    ...
    static toEntity = (createPlayerRequest: CreatePlayerRequest, credential: Credential, bmi?: number): Player => {
        ...
        player.position = createPlayerRequest.position ? stringToPosition(createPlayerRequest.position) : undefined;
