import { TrainingProgressResponse, CreateTrainingProgressRequest } from '../../domain/interfaces';
import { TrainingProgress, TrainingAssignment, Player, Coach } from '../../infrastructure/models';
