import { TrainingPlanResponse, CreateTrainingPlanRequest, AiApiAnalyzeResponse } from '../../domain/interfaces';
import { TrainingPlan, Coach, Cluster } from '../../infrastructure/models';
import { TrainingPlanStatus } from '../../domain/interfaces/enums';
import { AiApiFullRecommendationsResponse, PlayerPhysicalResultsResponse, TeamAnalysisResultsResponse } from '../../domain/interfaces';
