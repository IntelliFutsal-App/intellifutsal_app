...
import { TrainingProgressRepository, TrainingAssignmentRepository, PlayerRepository, CoachRepository } from '../../../infrastructure/repository';
...
import { BadRequestException, NotFoundException, UnauthorizedException } from '../../../domain/exceptions';
import { COACH_NOT_FOUND_CREDENTIAL, PLAYER_NOT_FOUND_CREDENTIAL, TRAINING_ASSIGNMENT_NOT_FOUND, TRAINING_PROGRESS_NOT_ACTIVE_ASSIGNMENT, TRAINING_PROGRESS_NOT_ALLOWED_TO_CREATE_FOR_ANOTHER_PLAYER, TRAINING_PROGRESS_NOT_ALLOWED_TO_VERIFY_FOR_ANOTHER_COACH, TRAINING_PROGRESS_NOT_FOUND } from '../../../core/utilities/messages.utility';
import { TrainingAssignmentStatus } from '../../../domain/interfaces/enums';
