...
import { TemplateConfig, TemplateData, TemplateType } from '../../../domain/interfaces';
import { ITemplateService } from "../template.service.interface";
import { BadRequestException, InternalServerException } from '../../../domain/exceptions';
import { TEMPLATE_ERROR, TEMPLATE_FIELDS_REQUIRED, TEMPLATE_NAME, TEMPLATE_NOT_FOUND } from '../../../core/utilities/messages.utility';
