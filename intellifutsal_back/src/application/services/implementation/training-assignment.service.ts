...
import { TrainingAssignmentRepository, TrainingPlanRepository, PlayerRepository, TeamRepository, CoachRepository } from '../../../infrastructure/repository';
...
import { TrainingAssignmentStatus, TrainingPlanStatus } from '../../../domain/interfaces/enums';
import { TRAINING_ASSIGNMENT_NOT_FOUND, TRAINING_PLAN_NOT_FOUND, PLAYER_NOT_FOUND, TEAM_NOT_FOUND, COACH_NOT_FOUND_CREDENTIAL, PLAYER_NOT_FOUND_CREDENTIAL } from '../../../core/utilities/messages.utility';
