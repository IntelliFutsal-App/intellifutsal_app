import { BadRequestException, InternalServerException, NotFoundException, UnauthorizedException } from '../../../domain/exceptions';
import { CreateTrainingPlanRequest, TrainingPlanResponse, UpdateTrainingPlanStatusRequest } from '../../../domain/interfaces';
import { TrainingPlanRepository, CoachRepository, ClusterRepository } from '../../../infrastructure/repository';
import { TrainingPlanMapper } from '../../mappers';
import { COACH_NOT_FOUND_CREDENTIAL, INTERNAL_SERVER_ERROR, PLAYER_NOT_FOUND, TEAM_NOT_FOUND, TRAINING_PLAN_NOT_FOUND, TRAINING_PLAN_NOT_PENDING_APPROVAL, TRAINING_PLAN_SAVE_ERROR } from '../../../core/utilities/messages.utility';
import { validateRequest } from '../../../core/utilities/validations.utility';
import { createTrainingPlanSchema } from "../../dto";
import { TrainingPlanStatus } from '../../../domain/interfaces/enums';
import { PlayerRepository, TeamRepository } from '../../../infrastructure/repository';
