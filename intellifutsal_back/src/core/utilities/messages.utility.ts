...
export const AI_SERVICE_TEAM_WITHOUT_PLAYERS_PREDICTION_ERROR: string = "El equipo seleccionado no tiene jugadores asociados para ser evaluado por el servicio de IA";
export const AI_SERVICE_TEAM_PLAYERS_WITHOUT_COMPLETE_DATA_PREDICTION_ERROR: string = "Los siguientes jugadores no tienen datos completos para ser evaluados por el servicio de IA: ";
export const AI_SERVICE_PLAYER_WITHOUT_COMPLETE_DATA_PREDICTION_ERROR: string = "El jugador no tiene todos los datos requeridos para ser evaluado por el servicio de IA. Faltan: ";