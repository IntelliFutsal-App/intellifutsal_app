...
import { Cluster, Coach, CoachTeam, Credential, JoinRequest, Player, PlayerCluster, PlayerTeam, RefreshToken, Team, TrainingAssignment, TrainingPlan, TrainingProgress } from "../../infrastructure/models";
...
export const AppDataSource = new DataSource({
    ...
    migrations: [
        __dirname + "/../../infrastructure/migrations/*.{js,ts}"
    ],
