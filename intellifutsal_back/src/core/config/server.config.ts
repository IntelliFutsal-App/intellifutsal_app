...
import { aiApiRouter, authRouter, clusterRouter, coachRouter, coachTeamRouter, dashboardRouter, joinRequestRouter, playerClusterRouter, playerRouter, playerTeamRouter, profileRouter, teamRouter, trainingAssignmentRouter, trainingPlanRouter, trainingProgressRouter, userRouter } from "../../interface/routes";
