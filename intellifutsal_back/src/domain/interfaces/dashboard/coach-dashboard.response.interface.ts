import { CountByKeyResponse, CountByStatusResponse, DayOfWeekPointResponse, JoinRequestReviewTimeResponse, PositionDistributionResponse, TeamActivityResponse, TeamMiniResponse, TimeSeriesPointResponse } from ".";


export class CoachDashboardResponse {
