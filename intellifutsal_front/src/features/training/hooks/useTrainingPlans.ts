...
import type { TrainingPlanResponse, UpdateTrainingPlanStatusRequest } from "../types";
import { trainingAssignmentService, trainingPlanService } from "../services";
import type { AssignPlanData } from "../components";
...
export const useTrainingPlans = () => {
    ...
    const fetchPlans = useCallback(async () => {
        ...
        try {
            setLoading(true);
            const data = await trainingPlanService.findMyPlans();
